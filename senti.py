...
def second():
    ...
    file= open(r"C:\Users\123.DESKTOP-TI7JP6K\Documents\Sanjeet project\Project Code\input.txt","r")
    ...
    with file as f:
        for line in f.read().split('\n'):
            ...
            pos_count+=1
        file.close()
    file1= open(r"C:\Users\123.DESKTOP-TI7JP6K\Documents\Sanjeet project\Project Code\input.txt","r")
    neg_count=0
    neg_correct=0
